  ...
  app: {
    ...
    head: {
      ...
      meta: [
        ...
        { name: 'description', content: 'Lexbell es la app de escritorio para gestionar expedientes legales: casos, plazos, documentos y notas, todo local en tu equipo. Para Mac y Windows.' },
