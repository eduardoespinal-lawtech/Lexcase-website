...
<template>
  <section class="section">
    <div class="apple-wrap text-center">
      <h1 class="h-page">{{ t('terms.title') }}</h1>
      <p class="mt-4 text-smoke text-[14px]">{{ t('terms.updated') }}</p>
    </div>
  </section>

  <section class="section-tight">
    <article class="apple-wrap prose-legal" style="max-width: 740px;">
      <p>{{ t('terms.intro') }}</p>
