    ...
    <div class="apple-wrap-wide privacy-layout">
      ...
      <article class="privacy-content prose-legal">
        ...
        <template v-if="locale === 'es'">
          ...
          <p>Lexbell almacena localmente en tu equipo la siguiente información que tú mismo introduces:</p>
          <ul>
          ...
          <ul>
            <li><strong>Exportar</strong> una copia de seguridad en formato JSON a la ubicación que tú elijas en tu equipo.</li>
          ...
          <p>Como toda la información vive en tu equipo, tú tienes el control total: puedes acceder, modificar, exportar o eliminar tus datos en cualquier momento desde la propia Aplicación, sin pedirnos permiso ni esperar respuesta.</p>
        ...
        <template v-else>
          ...
          <p>Lexbell stores locally on your device the following information you enter yourself:</p>
          <ul>
          ...
          <ul>
            <li><strong>Export</strong> a backup in JSON format to a location you choose on your device.</li>
          ...
          <p>Your data lives in the App's private container on your device, protected by your system's native security measures. To add protection, we recommend:</p>
          <ul>
            <li>Keeping your device up to date</li>
            <li>Enabling full-disk encryption (FileVault on Mac, BitLocker on Windows)</li>
            <li>Using a strong password on your user account</li>
          </ul>

          <h2 id="sincronizacion">8. Future sync services</h2>
          <p>We are evaluating an <strong>optional</strong> end-to-end encrypted sync service across multiple devices of the same user. If we launch it, it will be strictly opt-in, clearly communicated, and documented in this Policy before being enabled. Until then, Lexbell remains 100% local.</p>
          ...
          <p>Because all data lives on your device, you are in full control: you can access, modify, export or delete your data at any time from within the App, without asking us or waiting for a response.</p>
