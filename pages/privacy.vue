  ...
  <div>
    <section class="section-navy">
      <div class="max-w-7xl mx-auto px-5 sm:px-8 pt-16 pb-12">
        ...
        <h1 class="mt-4 text-4xl sm:text-5xl font-semibold tracking-tight text-white">{{ t('privacy.title') }}</h1>
        <p class="mt-3 text-sm text-navy-200">{{ t('privacy.updated') }}</p>
      </div>
    </section>
