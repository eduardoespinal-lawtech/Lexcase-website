...
/* Misma altura exacta que Apple. Ancho natural según la proporción del SVG
   oficial (ratio 3.66 → ~263px de ancho). Sin caja forzada, sin aire vacío
   interno — el SVG se ve a su tamaño nativo. */
.store-badge {
  display: inline-flex;
  align-items: center;
  height: 72px;
